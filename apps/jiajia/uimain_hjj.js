...
ui.layout(
    ...
    <viewpager id="viewpager">
        ...
        <frame>
            ...
            <relative id="rl_top1" bg="#E6FFFFFF" layout_alignParentTop="true" w="*" h="108dp">
...
addnewapp("火火视频极速版", 2, 30)

addnewapp("佳人记账", 2, 60)

addnewapp("快手极速版", 2, 180)

addnewapp("快逗短视频", 2, 100)

addnewapp("有颜短视频", 2, 100)

addnewapp("小吃货短视频", 2, 100)

addnewapp("变身记短视频", 2, 100)

addnewapp("趣宠短视频", 2, 100)

addnewapp("音浪短视频", 2, 100)

addnewapp("高手短视频", 2, 100)

addnewapp("刷宝短视频", 2, 100)
...
addnewapp("抖音极速版", 2, 30)

addnewapp("火山极速版", 2, 70)

addnewapp("牛角免费小说", 1, 150)
...
ui.sw_wuzhangai.on("check", function(checked) {
...
ui.cb_all.on("check", function(checked) {
