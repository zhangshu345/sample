...
// function runDouyin(shareUrl) {
//   // 1.根据分享的视频地址，通过重定向获取整个html信息
//   const { data: html } =  request(shareUrl);
...
//   const { data: videoJson } = request(long_url);
...
//   const { data: videoStream } =  request(noWatermarkUrl, 'stream');
...
// // log(axios("https://v.douyin.com/JGXBAHF/"))

let d=request("https://v.douyin.com/JGXBAHF/")
log(d)