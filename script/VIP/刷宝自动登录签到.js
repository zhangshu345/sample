...
var 刷宝弹出窗id=[刷宝视频恭喜获取关闭按钮id, 刷宝视频广告关闭按钮2id,刷宝视频广告关闭按钮1id]
var 刷宝视频页标志id=["com.jm.video:id/image_view","com.jm.video:id/comment"]
var bt_sign_id=""
...
var 刷宝获取账号信息=function(){
 ...
 if(回到刷宝首页()){
   while(true){
    ...
    clicktexts(["微信账号登录","同意"],1000,1500)
    if(textclick("微信账号登录")){
        sleep(1500)
       if( textclick("同意")){
           sleep(1500)
