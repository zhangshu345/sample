...
function newWebSocket(url,options){
    options = options || {};
    return new com.hongshu.autojs.core.web.JsWebSocket(http.__okhttp__, url, runtime, options.eventThread == 'this');
}
WebsocketHeartbeatJs.prototype.createWebSocket = function () {
    try {
        //this.ws = new WebSocket(this.opts.url);
        this.ws = newWebSocket(this.opts.url, { eventThread: 'this' });
...
const options = {
    url: 'ws://127.0.0.1:9999',//ip地址，请修改为websocket服务端对应地址
    pingTimeout: 5000,
    pongTimeout: 3000,
